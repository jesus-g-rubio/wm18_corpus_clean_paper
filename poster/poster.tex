...
After initial tests, we choose Gradient Boosting\footnote{\url{https://en.wikipedia.org/wiki/Gradient_boosting}}~\cite{Friedman02} as the classifier for our final submission
\begin{itemize}
