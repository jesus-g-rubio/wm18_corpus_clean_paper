...
\begin{itemize}
  ...
  \item \textit{Cross-entropy (2 f.)}: ``distance'' between the sentences according to a bag-of-words model. Computed for both source and target sentences, e.g. for the source:
...
\begin{itemize}
  \item Negative examples are a %``perturbed''
  distorted version of positive sentence pairs
